...
<div style="max-width: 1000px; margin: 0 auto;">
    <div style="margin-bottom: 40px; display: flex; justify-content: space-between; align-items: flex-end;">
        <div>
            ...
            <h1 style="font-size: 2.2rem; font-weight: 900; color: #fff; letter-spacing: -1px;">Establish Page Pillar</h1>
        </div>
    </div>
        ...
        <div class="admin-card">
            <div class="form-group" style="margin-bottom: 0;">
                ...
                <div style="position: relative; display: flex; align-items: center;">
                    ...
                    <input name="slug" type="text" value="{{ old('slug') }}" class="form-control" style="padding-left: 32px;" placeholder="our-legacy" required>
                </div>
