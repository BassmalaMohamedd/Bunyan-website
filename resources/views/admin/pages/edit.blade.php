...
<div class="max-w-4xl mx-auto">
    <div class="mb-12">
        ...
        <h1 class="text-4xl font-black text-white tracking-tight">Refine Segment Modular</h1>
        <p class="text-gray-400 mt-2 font-medium">Update the dynamic specifications for this Vertex ecosystem pillar.</p>
    </div>
    ...
    <form action="{{ route('admin.pages.update', $page->id) }}" method="POST" class="space-y-8">
            ...
            <div class="grid grid-cols-1 gap-10 text-[#1c1917]">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input name="slug" type="text" placeholder="about-vertex" value="{{ old('slug', $page->slug) }}" required
                ...
                <div class="grid grid-cols-2 gap-10 border-t border-gray-50 pt-10">
                    ...
                    <div class="space-y-6 text-left">
                        ...
                        <div>
                            ...
                            <input name="title[en]" type="text" placeholder="The Vertex Legacy" value="{{ old('title.en', $page->title['en'] ?? '') }}" required
                        ...
                        <div>
                            ...
                            <textarea name="content[en]" rows="12" placeholder="Detail the innovation..."
                                class="w-full bg-gray-50 border-transparent focus:bg-white focus:border-[#f59e0b] focus:ring-0 rounded-2xl py-4 px-6 text-[#1c1917] font-medium transition-all resize-none text-left">{{ old('content.en', $page->content['en'] ?? '') }}</textarea>
                    ...
                    <div class="space-y-6 text-right" dir="rtl">
                        ...
                        <div>
                            ...
                            <input name="title[ar]" type="text" placeholder="إرث فيرتكس" value="{{ old('title.ar', $page->title['ar'] ?? '') }}" required
                        ...
                        <div>
                            ...
                            <textarea name="content[ar]" rows="12" placeholder="تفاصيل الابتكار..."
                                class="w-full bg-gray-50 border-transparent focus:bg-white focus:border-[#f59e0b] focus:ring-0 rounded-2xl py-4 px-6 text-[#1c1917] font-medium transition-all resize-none text-right">{{ old('content.ar', $page->content['ar'] ?? '') }}</textarea>
        ...
        <div class="flex justify-end gap-6">
            <a href="{{ route('admin.pages.index') }}" class="px-8 py-4 text-gray-400 hover:text-white font-bold uppercase text-xs tracking-widest transition-colors no-underline">Cancel Modification</a>
            <button type="submit"
                ...
                <span>Update Narrative Module</span>
