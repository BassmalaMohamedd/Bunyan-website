...
<div style="max-width: 1000px; margin: 0 auto;">
    <div style="margin-bottom: 40px; display: flex; justify-content: space-between; align-items: flex-end;">
        <div>
            ...
            <h1 style="font-size: 2.2rem; font-weight: 900; color: #fff; letter-spacing: -1px;">Update Service</h1>
        </div>
    </div>
        ...
        <div class="admin-card">
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 24px;">
                <div class="form-group">
                    ...
                    <input name="slug" type="text" value="{{ old('slug', $service->slug) }}" class="form-control" required>
                ...
                <div class="form-group">
                    ...
                    <input name="icon" type="text" value="{{ old('icon', $service->icon) }}" class="form-control">
                </div>
            </div>
            ...
            <div style="display: flex; align-items: center; justify-content: space-between; padding-top: 24px; border-top: 1px solid rgba(255,255,255,0.05);">
                <div>
                    ...
                    <div style="color: rgba(255,255,255,0.3); font-size: 0.65rem; margin-top: 4px;">Control whether this service is visible in the public ecosystem.</div>
                </div>
                <label style="position: relative; display: inline-block; width: 60px; height: 34px; cursor: pointer;">
                    <input type="hidden" name="is_active" value="0">
                    <input type="checkbox" name="is_active" value="1" {{ $service->is_active ? 'checked' : '' }} style="opacity: 0; width: 0; height: 0;" class="peer">
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 24px;">
            ...
            <div class="admin-card">
                ...
                <div class="form-group">
                    ...
                    <input name="title[en]" type="text" value="{{ old('title.en', $service->title['en'] ?? '') }}" class="form-control" required>
                </div>
                <div class="form-group" style="margin-bottom: 0;">
                    <label class="form-label">Description</label>
                    <textarea name="description[en]" rows="10" class="form-control" style="resize: none;" required>{{ old('description.en', $service->description['en'] ?? '') }}</textarea>
                </div>
            </div>
            ...
            <div class="admin-card" dir="rtl">
                ...
                <div class="form-group">
                    ...
                    <input name="title[ar]" type="text" value="{{ old('title.ar', $service->title['ar'] ?? '') }}" class="form-control" style="text-align: right;" required>
                </div>
                <div class="form-group" style="margin-bottom: 0;">
                    <label class="form-label" style="text-align: right;">الوصف</label>
                    <textarea name="description[ar]" rows="10" class="form-control" style="resize: none; text-align: right;" required>{{ old('description.ar', $service->description['ar'] ?? '') }}</textarea>
                </div>
            </div>
        </div>
