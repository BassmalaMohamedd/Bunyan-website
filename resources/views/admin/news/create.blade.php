...
<div style="max-width: 1000px; margin: 0 auto;">
    <div style="margin-bottom: 40px; display: flex; justify-content: space-between; align-items: flex-end;">
        <div>
            ...
            <h1 style="font-size: 2.2rem; font-weight: 900; color: #fff; letter-spacing: -1px;">Publish Insight</h1>
        </div>
    </div>
        ...
        <div class="admin-card">
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 24px;">
                <div class="form-group">
                    ...
                    <input name="slug" type="text" value="{{ old('slug') }}" class="form-control" placeholder="riyadh-expansion-2026" required>
                    @error('slug') <p style="color: #f87171; font-size: 0.75rem; font-weight: 700; margin-top: 8px;">{{ $message }}</p> @enderror
                </div>
                <div class="form-group">
                    <label class="form-label">Publication Date</label>
                    <input name="published_at" type="date" value="{{ old('published_at', date('Y-m-d')) }}" class="form-control" required>
            ...
            <div class="form-group" style="margin-bottom: 0;">
                ...
                <input name="image" type="text" value="{{ old('image') }}" class="form-control" placeholder="/images/news/hero.jpg">
            </div>
        </div>
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 24px;">
            ...
            <div class="admin-card">
                ...
                <div class="form-group" style="margin-bottom: 0;">
                    ...
                    <textarea name="content[en]" rows="10" class="form-control" style="resize: none;" required>{{ old('content.en') }}</textarea>
                </div>
            </div>
            ...
            <div class="admin-card" dir="rtl">
                ...
                <div class="form-group" style="margin-bottom: 0;">
                    ...
                    <textarea name="content[ar]" rows="10" class="form-control" style="resize: none; text-align: right;" required>{{ old('content.ar') }}</textarea>
                </div>
            </div>
        </div>
