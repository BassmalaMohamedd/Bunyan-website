...
<template>
    <Head title="Publish Intelligence - Admin" />
    <AdminLayout>
        <div class="max-w-4xl mx-auto">
            <div class="mb-12">
                ...
                <h1 class="text-4xl font-black text-secondary tracking-tight">Publish Market Intel</h1>
                <p class="text-gray-400 mt-2 font-medium">Broadcast new specialized intelligence to the Arkan network.</p>
            </div>
            ...
            <form @submit.prevent="submit" class="space-y-8">
                ...
                <div class="flex justify-end gap-6">
                    ...
                    <button type="submit" :disabled="form.processing"
                        ...
                        <span v-else>Authorize Broadcast</span>
